...
class TestCalibrationFormat:
    ...
    def test_calibration_format_pandas(self, lung_surv) -> None:
        ...
        assert list(result.columns) == ["bin", "n", "predicted", "observed", "observed_lower", "observed_upper"]
    ...
    def test_calibration_format_pyarrow(self, lung_surv) -> None:
        ...
        assert list(result.column_names) == ["bin", "n", "predicted", "observed", "observed_lower", "observed_upper"]
